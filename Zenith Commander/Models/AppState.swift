...
extension AppState {
    func executeCommand() async {
        ...
        func executeMove(command: ParsedCommand, currentPath: URL) async {
        ...
        /// 执行复制命令
        func executeCopy(command: ParsedCommand, currentPath: URL) async {
            let result = CommandParser.validateMoveOrCopy(
                command,
                currentPath: currentPath
            )
        ...
        /// 执行删除命令
        func executeDelete(command: ParsedCommand, currentPath: URL) async {
