...
struct FileSystemServiceTests {
    ...
    @Test func directoryExistsCheck() {
        let service = FileSystemService.shared
        let homeDir = FileManager.default.homeDirectoryForCurrentUser
    ...
    @Test func directoryNotExistsCheck() {
        let service = FileSystemService.shared
    ...
    @Test func createFile_Basic() async throws {
        let service = FileSystemService.shared
    ...
    @Test func createFile_MultipleConflicts() async throws {
        let service = FileSystemService.shared
        let fileManager = FileManager.default
        let tempDir = fileManager.temporaryDirectory.appendingPathComponent("ZenithTest_\(UUID().uuidString)")
    ...
    @Test func createFile_EmptyFile() async throws {
        let service = FileSystemService.shared
        let fileManager = FileManager.default
        let tempDir = fileManager.temporaryDirectory.appendingPathComponent("ZenithTest_\(UUID().uuidString)")
    ...
    @Test func createDirectory_Basic() async throws {
        let service = FileSystemService.shared
        let fileManager = FileManager.default
        let tempDir = fileManager.temporaryDirectory.appendingPathComponent("ZenithTest_\(UUID().uuidString)")
    ...
    @Test func createDirectory_MultipleConflicts() async throws {
        let service = FileSystemService.shared
        let fileManager = FileManager.default
        let tempDir = fileManager.temporaryDirectory.appendingPathComponent("ZenithTest_\(UUID().uuidString)")
    ...
    @Test func createDirectory_ConflictWithFile() async throws {
        let service = FileSystemService.shared
        let fileManager = FileManager.default
        let tempDir = fileManager.temporaryDirectory.appendingPathComponent("ZenithTest_\(UUID().uuidString)")
